\notetitle{Obj-GAN \cite{DBLP:journals/corr/abs-1902-10740}} %  subject
\noteconference{CVPR2019}
\notelink{https://arxiv.org/abs/1902.10740}
\notedate{Sunday, Jun 30, 2019} % Date, set to \today for automatically printing todays date
\notecode{None}

%\logo{\includegraphics[width=0.3\textwidth]{logo.png}} % Institution logo at the top right of the , comment out this line for no logo

%----------------------------------------------------------------------------------------

\maketitle % Print the  header information
